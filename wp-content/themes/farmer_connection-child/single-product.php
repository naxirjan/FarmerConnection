...
<div class="col-sm-1"> </div>          
    ...
    <h1 class="text-light text-center"><b><?php  the_title();?></b></h1>
    <p><span class="text-light"><b><?php echo $cat[0];?></b></span> /<b><?php echo $cat[1];?></b></p>
    <hr />
    <h5><span class="badge badge-warning"><?php echo $featured;?></span></h5>
    <h5><b><span class="text-light">Price:</span>$<?php echo $price;?></b></h5>
    <?php
                if($get_all_meta_values["stock"][0])
                {
                    ?>
                        <small class="badge badge-warning"><b>(Stock:&nbsp;<?php echo $stock;?>)</b></small><br />
                    <?php
                }
    ?>            
    <?php
        ...
        {
            ?>
             <h5><b><span class="text-light">Contact Email: </span><?php echo $email;?></b></h5>
            <?php
        }        
   
    if($user->roles[0]=='administrator'){?>  
    <br />
     <input type="number" class="form-control w-50 bg-dark text-light" id="quantity" value="1" min="1" max="10" required/><br />
     <button class="btn btn-dark" id="btn-add-cart"><b>Add to Cart</b></button>
     <?php
        }            
     ?>
...
<div id="close" class=" alert-dismissible fade show" role="alert">
 ...
 $(document).ready(function(){
    ...
    <div class="tab-pane fade" id="tabs_2_3" role="tabpanel" aria-labelledby="contact-tab">
        <h3><span class=" alert-danger rounded">&nbsp;7 Days Replacement Only&nbsp;</span></h3>
        <span>                            
        ...
        <h3><span class=" alert-danger rounded">&nbsp;Conditions For Returns&nbsp;</span></h3>                         <span>The product must be unused, unworn, unwashed and without any flaws.
...
<div class="col-sm-4 bg-info rounded" style="height:650px;">     
    <br />
...
$products = get_posts(array(
  ...
  'tax_query' => array(
    ...
    ?>
    <hr />
<h1 class="text-danger text-center"><b>Related Products</b></h1>
<div class="row">
<div class="col-sm-1"></div>  
...
foreach($products as $product)
{
    ...
    ?>
    <div class="col-sm-2 alert-info text-center rounded">
        <br />
