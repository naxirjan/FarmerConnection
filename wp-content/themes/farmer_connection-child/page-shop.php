...
<div class="row">
    ...
    <div class="col-sm-5 bg-info rounded">
        <form role="search"  action="<?php echo home_url("/");?>">
       <label></label>
        <input type="search" class="text-center search-field form-control field-group bg-dark" placeholder="<?php echo esc_attr_x("Enter the word to search","placeholder")?>" value="<?php echo get_search_query()?>" name="s" title="<?php esc_attr_x("Enter the word to search","label")?>" id="search-text"/> 
    ...
    <div class="col-sm-5 bg-info rounded">
        <label></label>
        <h1 class="text-light text-center"><b>Online Products<br />Purchasing</b></h1></div>
    <div class="col-sm-1"></div>
...
<div class="album py-5">
      <div class="col-sm-12" id="products_result">  
      <div class="row">    
         <div class="col-sm-3 bg-info rounded">
             <br />
            <h3 class="bg-dark text-light text-center">Categories</h3> 
           <div id="accordion">
  <?php
        $i=0;       
    ...
    <div id="collapse<?php echo $i;?>" class="collapse" aria-labelledby="heading<?php echo $i;?>" data-parent="#accordion">
      <div class="card-body">
       <?php
        ...
        {
        ?>
           <a id="search" cat_id="<?php echo $childTerm->term_id;?>"><h5 class="text-center btn-outline-dark rounded"><?php echo $childTerm->name ?></h5></a>
        <?php  
        }
        ?>
      </div>
    ...
    $stock = $get_all_meta_values["stock"][0]; 
        ...
        $cat = wp_get_object_terms( $post->ID, 'product_cats', array( 'fields' => 'names',"orderby"=>"term_id","order"=>"ASC" ) );
            ...
            <div class="col-md-3 rounded">
              <div class="card mb-3 box-shadow rounded alert-info">
                <br />
                ...
                <div class="card-body rounded alert-info">
